...
\
La idea era hacer una especie de juego de tipeo rápido, de esos que hay a mansalva en varias páginas web. Se llama TipeoNada y podes jugarlo [acá](https://storage.googleapis.com/tipeo-nada-web/TipeoNadaWeb.html) y todo el código del juego lo podés encontrar [acá](https://github.com/francoserio/tipeo-nada)
