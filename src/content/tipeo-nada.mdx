...
\
La idea era hacer una especie de juego de tipeo rápido, de esos que hay a mansalva en varias páginas web. Se llama TipeoNada y podes jugarlo <Anchor text="acá" href="https://tipeo-nada.sam-ser.com/TipeoNadaWeb.html" /> y todo el código del juego lo podés encontrar <Anchor text="acá" href="https://github.com/francoserio/tipeo-nada" />.
