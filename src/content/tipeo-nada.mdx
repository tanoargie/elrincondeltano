---
title: Tipeo Nada
subtitle: Primer juego que hago en C++ (SDL2), un ejercicio para tipear
imgPath: ../images/tipeo-nada.png
slug: tipeo-nada
tags:
  - gamedev
  - C++
...
\
La idea era hacer una especie de juego de tipeo rápido, de esos que hay a mansalva en varias páginas web. Se llama TipeoNada y podes jugarlo <a href="https://storage.googleapis.com/tipeo-nada-web/TipeoNadaWeb.html" target="_blank" style={{ color: 'blue', textDecoration: 'underline' }}>acá</a> y todo el código del juego lo podés encontrar <a href="https://github.com/francoserio/tipeo-nada" target="_blank" style={{ color: 'blue', textDecoration: 'underline' }}>acá</a>
